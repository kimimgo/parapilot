...
def _get_tool_fn(name: str):
    ...
    import parapilot.server as srv
...
class TestInspectDataTool:
    ...
    async def test_inspect_data_delegates(self):
        ...
        with patch("parapilot.tools.inspect.inspect_data_impl", new_callable=AsyncMock, return_value=mock_result):
...
class TestRenderTool:
    ...
    async def test_render_returns_image(self):
        ...
        with patch("parapilot.tools.render.render_impl", new_callable=AsyncMock, return_value=mock_pr):
    ...
    async def test_render_passes_all_params(self):
        ...
        with patch("parapilot.tools.render.render_impl", mock_impl):
            fn = _get_tool_fn("render")
            await fn(
...
class TestSliceTool:
    ...
    async def test_slice_returns_image(self):
        mock_pr = _make_pipeline_result()
        with patch("parapilot.tools.filters.slice_impl", new_callable=AsyncMock, return_value=mock_pr):
...
class TestContourTool:
    ...
    async def test_contour_returns_image(self):
        mock_pr = _make_pipeline_result()
        with patch("parapilot.tools.filters.contour_impl", new_callable=AsyncMock, return_value=mock_pr):
...
class TestClipTool:
    ...
    async def test_clip_returns_image(self):
        mock_pr = _make_pipeline_result()
        with patch("parapilot.tools.filters.clip_impl", new_callable=AsyncMock, return_value=mock_pr):
...
class TestStreamlinesTool:
    ...
    async def test_streamlines_returns_image(self):
        mock_pr = _make_pipeline_result()
        with patch("parapilot.tools.filters.streamlines_impl", new_callable=AsyncMock, return_value=mock_pr):
...
class TestExtractStatsTool:
    ...
    async def test_extract_stats_delegates(self):
        ...
        with patch("parapilot.tools.extract.extract_stats_impl", new_callable=AsyncMock, return_value=mock_result):
...
class TestPlotOverLineTool:
    ...
    async def test_plot_over_line_delegates(self):
        ...
        with patch("parapilot.tools.extract.plot_over_line_impl", new_callable=AsyncMock, return_value=mock_result):
...
class TestIntegrateSurfaceTool:
    ...
    async def test_integrate_surface_delegates(self):
        ...
        with patch("parapilot.tools.extract.integrate_surface_impl", new_callable=AsyncMock, return_value=mock_result):
...
class TestAnimateTool:
    ...
    async def test_animate_returns_json(self):
        ...
        with patch("parapilot.tools.animate.animate_impl", new_callable=AsyncMock, return_value=mock_pr):
...
class TestSplitAnimateTool:
    ...
    async def test_split_animate_gif(self):
        ...
        with patch("parapilot.tools.split_animate.split_animate_impl", new_callable=AsyncMock, return_value=mock_pr):
...
class TestExecutePipelineTool:
    ...
    async def test_pipeline_image_output(self):
        ...
        with patch("parapilot.tools.pipeline.execute_pipeline_impl", new_callable=AsyncMock, return_value=mock_pr):
...
class TestCinematicRenderTool:
    ...
    async def test_cinematic_returns_image(self):
        ...
        with patch("parapilot.tools.cinematic.cinematic_render_impl", mock):
    ...
    async def test_cinematic_raises_on_none(self):
        with patch("parapilot.tools.cinematic.cinematic_render_impl", new_callable=AsyncMock, return_value=None):
            fn = _get_tool_fn("cinematic_render")
    ...
    async def test_cinematic_all_params(self):
        ...
        with patch("parapilot.tools.cinematic.cinematic_render_impl", mock_impl):
            fn = _get_tool_fn("cinematic_render")
            await fn(
...
class TestCompareTool:
    ...
    async def test_compare_returns_image(self):
        with patch("parapilot.tools.compare.compare_impl", new_callable=AsyncMock, return_value=b"\x89PNG_cmp"):
    ...
    async def test_compare_raises_on_none(self):
        with patch("parapilot.tools.compare.compare_impl", new_callable=AsyncMock, return_value=None):
            fn = _get_tool_fn("compare")
    ...
    async def test_compare_diff_mode(self):
        ...
        with patch("parapilot.tools.compare.compare_impl", mock_impl):
            fn = _get_tool_fn("compare")
...
class TestProbeTimeseriesTool:
    ...
    async def test_probe_delegates(self):
        ...
        with patch("parapilot.tools.probe.probe_timeseries_impl", new_callable=AsyncMock, return_value=mock_result):
...
class TestBatchRenderTool:
    ...
    async def test_batch_render_delegates(self):
        ...
        with patch("parapilot.tools.batch.batch_render_impl", new_callable=AsyncMock, return_value=mock_result):
...
class TestPreview3dTool:
    ...
    async def test_preview_3d_delegates(self):
        ...
        with patch("parapilot.tools.preview3d.preview_3d_impl", new_callable=AsyncMock, return_value=mock_result):
...
class TestPvIsosurfaceTool:
    ...
    async def test_pv_isosurface_delegates(self):
        ...
        with patch("parapilot.tools.isosurface.pv_isosurface_impl", new_callable=AsyncMock, return_value=mock_result):
