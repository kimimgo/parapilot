...
async def compare_impl(
    ...
    *,
    ...
    def _run() -> bytes:
        ...
        from parapilot.engine.renderer_cine import cinematic_render as _cine_render
        ...
        if shared_range is None and field_name:
            from parapilot.engine.renderer import _get_scalar_range, _resolve_array, _resolve_renderable
...
def _compose_diff(data_a: Any, data_b: Any, field_name: str, config: Any) -> bytes:
    ...
    from parapilot.engine.renderer import _resolve_array, _resolve_renderable
